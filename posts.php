...
$sql = "SELECT *, id as post_id from posts order by created_at desc";
  ...
  <body>
   ...
   <?php foreach ($posts as $post) { ?>
          ...
          <div class="blog-post">
            ...
            <?php } ?>
            <h2 class="blog-title-color">Heading</h2>
            <p>
            ...
            <h3 class="blog-title-color">Sub-heading</h3>
            <p>
          ...
          <div class="blog-post">
            <h2 class="blog-post-title blog-title-color">Another blog post</h2>
            <p class="blog-post-meta">
          ...
          <div class="blog-post">
            <h2 class="blog-post-title blog-title-color">New feature</h2>
            <p class="blog-post-meta">
